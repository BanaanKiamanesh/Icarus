classdef MotionPlotter < handle
    ...
    methods
        function obj = MotionPlotter(t, Motion, CtrlSig, Thrusts, Err, RefSig, ArmLength, S)
            % Plt = MotionPlotter(t,      X,    Uout,   Omega, Err,     Xd,  DynPar.l)
            
            % Unpack Motion to Pos, Vel, Orient and Ang Orient
            obj.Pos    = real(Motion([7, 9, 11], :));
            obj.Vel    = real(Motion([8, 10, 12], :));
            obj.Orient = real(Motion([1, 3, 5], :));
            obj.Omega  = real(Motion([2, 4, 6], :));
        ...
        function PlotSlidingSurfaces(obj, Save)
            ...
            % Create Plot Object
            obj.SlidingSurfacePlot = figure('Name', 'Sliding Surfaces Plots', ...
                'Units', 'normalized', 'OuterPosition', [0, 0, 1, 1]);
            obj.SlidingSurfacePlot.GraphicsSmoothing = 'on';
            obj.SlidingSurfacePlot.Color = [1, 1, 1];
            
            % Set Super Title
            sgtitle('Sliding Surfaces', 'FontSize', 24,'FontWeight', 'Bold')
            
            % Plot Signals
            subplot(3, 2, 1)
            plot(obj.t, obj.SlidingSurface(1, :), 'LineWidth', 2.5)
            ylabel('S_\phi', 'FontSize', 10, 'FontWeight', 'Bold')
            xlabel('t (s)', 'FontSize', 10, 'FontWeight', 'Bold')
            grid minor
            title('Sliding Surface for Phi', 'FontSize', 14,'FontWeight', 'Bold')
            
            subplot(3, 2, 2)
            plot(obj.t, obj.SlidingSurface(2, :), 'LineWidth', 2.5)
            ylabel('S_\theta', 'FontSize', 10,'FontWeight', 'Bold')
            xlabel('t (s)', 'FontSize', 10,'FontWeight', 'Bold')
            grid minor
            title('Sliding Surface Theta', 'FontSize', 14,'FontWeight', 'Bold')
            
            subplot(3, 2, 3)
            plot(obj.t, obj.SlidingSurface(3, :), 'LineWidth', 2.5)
            ylabel('S_\psi', 'FontSize', 10,'FontWeight', 'Bold')
            xlabel('t (s)', 'FontSize', 10,'FontWeight', 'Bold')
            grid minor
            title('Sliding Surface Psi', 'FontSize', 14,'FontWeight', 'Bold')
            
            subplot(3, 2, 4)
            plot(obj.t, obj.SlidingSurface(4, :), 'LineWidth', 2.5)
            ylabel('S_x', 'FontSize', 10,'FontWeight', 'Bold')
            xlabel('t (s)', 'FontSize', 10,'FontWeight', 'Bold')
            grid minor
            title('Sliding Surface X', 'FontSize', 14,'FontWeight', 'Bold')
            
            subplot(3, 2, 5)
            plot(obj.t, obj.SlidingSurface(5, :), 'LineWidth', 2.5)
            ylabel('S_y', 'FontSize', 10,'FontWeight', 'Bold')
            xlabel('t (s)', 'FontSize', 10,'FontWeight', 'Bold')
            grid minor
            title('Sliding Surface Y', 'FontSize', 14,'FontWeight', 'Bold')
            
            subplot(3, 2, 6)
            plot(obj.t, obj.SlidingSurface(6, :), 'LineWidth', 2.5)
            ylabel('S_z', 'FontSize', 10,'FontWeight', 'Bold')
            xlabel('t (s)', 'FontSize', 10,'FontWeight', 'Bold')
            grid minor
            title('Sliding Surface Z', 'FontSize', 14,'FontWeight', 'Bold')
        ...
        function PlotThrusts(obj, Save)
            ...
            ylabel('T_1 (g)', 'FontSize', 10,'FontWeight', 'Bold')
            xlabel('t (s)', 'FontSize', 10,'FontWeight', 'Bold')
            grid minor
            ...
            ylabel('T_2 (g)', 'FontSize', 10,'FontWeight', 'Bold')
            xlabel('t (s)', 'FontSize', 10,'FontWeight', 'Bold')
            grid minor
            ...
            ylabel('T_3 (g)', 'FontSize', 10,'FontWeight', 'Bold')
            xlabel('t (s)', 'FontSize', 10,'FontWeight', 'Bold')
            grid minor
        ...
        function PlotLinearMotion(obj, Save)
            ...
            plot(obj.t, obj.RefSig(1, :), 'LineWidth', 2.5, 'LineStyle', '--')
            hold(gca, 'off');
            ...
            plot(obj.t, obj.RefSig(2, :), 'LineWidth', 2.5, 'LineStyle', '--')
            hold(gca, 'off');
            ...
            plot(obj.t, obj.RefSig(3, :), 'LineWidth', 2.5, 'LineStyle', '--')
            hold(gca, 'off');
        ...
        function Plot3D(obj, Save)
            ...
            obj.Path.addpoints(obj.Pos(1, 1), obj.Pos(2, 1), obj.Pos(3, 1));
            ...
            for i = 1:2:length(obj.Pos)
                ...
                Orientation = obj.Orient(1:3, i);
                Center      = obj.Pos(1:3, i);
